...
random.seed(10)
sentence_lst = []
roc_train = '/content/Diffusion-LM/datasets/ROCstory/ROCstory_full.csv'
...
with open('/content/Diffusion-LM/datasets/ROCstory/roc_valid.json', 'w') as f:
    for sent in valid_lst:
        print(json.dumps([sent]), file=f)

with open('/content/Diffusion-LM/datasets/ROCstory/roc_train.json', 'w') as f:
